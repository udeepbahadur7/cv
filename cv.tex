...
\begin{entrylist}
	...
	\entry
		...
		{www.infiniasmart.com}
		{
		    ...
		    \texttt{Vue.js}\slashsep\texttt{Django}\slashsep\textt{Docker}\slashsep\textt{Nginx}\slashsep\textt{Digital Ocean}
		}
	\entry
	...
	\entry
	    ...
	    {}
	    {
	        ...
	        \texttt{Django}\slashsep\textt{Django Rest Framework}\slashsep\textt{React\slashsep\textt{Redux}}\slashsep\textt{Redux Saga}
	    }
